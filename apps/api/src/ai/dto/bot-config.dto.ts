...
export class UpdateBotConfigDto {
  @IsOptional()
  @IsString()
  @MaxLength(100, { message: 'El nombre del bot no puede exceder 100 caracteres' })
  botName?: string;

  @IsOptional()
  @IsString()
  @MaxLength(500, { message: 'El estilo de prompt no puede exceder 500 caracteres' })
  promptStyle?: string;

  @IsOptional()
  @IsString()
  @MaxLength(500, { message: 'El mensaje de saludo no puede exceder 500 caracteres' })
  greeting?: string;
